...
import com.admin.web.service.impl.UserDetailServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception
	{
		http.authorizeRequests()
			.antMatchers("/menuSettings/**").hasRole("ADMIN")
		...
		http.formLogin()
			...
			.defaultSuccessUrl("/dashboard/realtime",true)
