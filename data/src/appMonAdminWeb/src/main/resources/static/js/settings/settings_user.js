...
function updateUserSetMenu(){
    ...
    if(setNewMenuNo != null && setNewMenuNo != ""){
        var url = "/settings/user/updateUserSetMenu";
        var param = {
            loginId : $('#logiId').text(),
...
function deleteSetUserMenu(loginId){
    var result = confirm("삭제하시겠습니까?");

    if(result){
        var url = "/settings/user/deleteSetUserMenu";
        var param = {
            loginId : loginId
        };
...
function selectSetUserMenuList(){
    var url = "/settings/user/selectSetUserMenu";
